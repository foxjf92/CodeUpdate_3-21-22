...
public class DriveTrain extends Subsystem {
    ...
    //Uncomment below and set Pigeon CAN ID, also
    //public static final int DRIVETRAIN_PIGEON_ID = 0; // FIXME Set Pigeon ID

    // 2022 Values
    private static final double FRONT_LEFT_ANGLE_OFFSET = -Math.toRadians(283.6);
    private static final double FRONT_RIGHT_ANGLE_OFFSET = -Math.toRadians(101.5);
    private static final double BACK_LEFT_ANGLE_OFFSET = -Math.toRadians(317.0);
    private static final double BACK_RIGHT_ANGLE_OFFSET = -Math.toRadians(317.0);
    ...
    //Comment below once Pigeon is integrated
    private AHRS navx;
